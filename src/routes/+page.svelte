  ...
  <div class="container">
    <nav>
      <div class="nav-right">
          ...
          <button class="btn" onclick="javascript:window.open('https://github.com/LarissaLAfonso/history-of-philosophy', '_blank');">
...
<style>
  ...
  * {
  ...
  .btn {
    ...
    align-items: center;
    gap: 0.5rem;
    background: linear-gradient(45deg, #8B4513, #BA6F3D);
    box-shadow: 0 6px 12px rgba(90, 45, 10, 0.7);
    color: #fff;
    font-family: 'Poppins', sans-serif;
    font-weight: 600;
    border: none;
  ...
  .btn:hover {
    background: linear-gradient(45deg, #6b3f16, #a05a2b);
    box-shadow: 0 8px 16px rgba(107, 63, 22, 0.6);
  ...
  .content h1 {
    ...
    line-height: 1.1;
    color: #F0E6DC;
    text-shadow: 2px 2px 4px rgba(58, 54, 51, 0.5);
    margin-bottom: 2rem;
    letter-spacing: 1px;
    position: relative;
  }
